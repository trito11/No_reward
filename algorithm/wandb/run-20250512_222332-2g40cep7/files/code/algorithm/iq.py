        ...
        if global_step > args.learning_starts:
            ...
            # exit()
                ...
                with torch.no_grad():
                    ...
                    qf1_next_target = qf1(mb_obs_next, next_state_actions)
                    qf2_next_target = qf2(mb_obs_next, next_state_actions)
                ...
                next_v_value_1 = (1 - mb_dones.flatten()) * args.gamma * (qf1_next_target).view(-1)

                next_v_value_2 = (1 - mb_dones.flatten()) * args.gamma * (qf2_next_target).view(-1)
                ...
                qf1_loss = F.mse_loss(torch.mean(mb_eps_rewards), torch.mean(pre_re_1))  + args.var_coefficient * r_var1 
                qf2_loss = F.mse_loss(torch.mean(mb_eps_rewards), torch.mean(pre_re_2))  + args.var_coefficient * r_var2 
