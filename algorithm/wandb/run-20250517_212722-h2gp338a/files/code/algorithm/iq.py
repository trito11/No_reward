    ...
    for global_step in range(args.total_timesteps):
        ...
        if global_step > args.learning_starts:
            ...
            # exit()
                ...
                pre_re_1_t = qf1_a_values.view(-1) - (1 - mb_dones.flatten()) * args.gamma * (min_qf_next_target).view(-1)
                pre_re_2_t = qf2_a_values.view(-1) - (1 - mb_dones.flatten()) * args.gamma * (min_qf_next_target).view(-1)
