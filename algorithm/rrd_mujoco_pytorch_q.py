    ...
    class RandomizedReturnDecomposition():
        ...
        def train(self, batch,train_q=False,train_policy=False):
            ...
            with autocast(enabled=False):
                ...
                self.e_reward2=self.reward2(self.obs_ph,self.rrd_acts_ph,self.obs_next_ph).to(torch.float32)
                ...
                self.reward_loss2=criterion(self.rrd_rews_ph, self.e_reward2.mean(dim=1))  
                # self.reward_loss3=criterion1(self.rrd_rews_ph, self.e_reward3)  
 
 
                target = (1.0 - self.done_ph) * self.args.gamma * self.q_t_2 + self.e_reward2.detach()            
                ...
                self.q_loss=criterion(self.q_1,target)
                ...
                if train_q:
                    ...
                    scaler.scale(self.q_loss).backward()
